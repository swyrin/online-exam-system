...
(
    ...
    constraint FKcxggcgte30eenqoiw89xm9dt8 foreign key (role_role_id) references roles (role_id) on delete cascade,
...
(
    ...
    constraint FKa88c29pvhw6e7xrdcbr67krqg foreign key (person_id) references persons (person_id) on delete cascade,
    constraint FKnp5u8xq9kjlfhsaax7o5o2ouf foreign key (course_id) references courses (course_id) on delete cascade
);
...
(
    ...
    constraint FK7dj7k6wo992tbjbqhkcdxq4n9 foreign key (person_id) references persons (person_id) on delete cascade,
    constraint FKuev9qsnurv56g4dwupx2p63h foreign key (course_id) references courses (course_id) on delete cascade
);
...
(
    ...
    constraint FKdplytyuajc4htyion192ii01s foreign key (room_id) references rooms (room_id) on delete cascade,
    constraint FKdyt03ca2c6ibqjtieoytt4oth foreign key (course_id) references courses (course_id) on delete cascade
);
...
(
    ...
    constraint FKau9b8s5qig0qhyh12yqlxjj6e foreign key (person_id) references persons (person_id) on delete cascade,
    constraint FKgc2yaw61lqr2eevc2bep0688q foreign key (room_id) references rooms (room_id) on delete cascade
);
...
(
    ...
    constraint FKgujq84gqhfqd96d1so4gmn8bu foreign key (exam_type_type_id) references test_types (type_id) on delete cascade,
    constraint FKihnbtgx6sw5kyidarrf21cfq3 foreign key (course_course_id) references courses (course_id) on delete cascade
);
